...
void scheduling_table_t::update_row(unsigned component_pos_,
    ...
    // Debug: Print component_pos_ and mapping_values_
    // std::cout << "Updating row: " << component_pos_ << std::endl;
    // std::cout << "New mapping values: ";
    // for (const auto& value : mapping_values_) {
    //     std::cout << value << " ";
    // }
    // std::cout << std::endl;
